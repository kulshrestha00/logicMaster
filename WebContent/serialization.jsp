...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="serialization.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Serialization and Deserialization</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/qo9S2CeoqQE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <hr style="color: black">
            <br>

            <p style="font-size: 18px"> 
              Serialization is a mechanism of converting the state of an object into a byte stream. Deserialization is the reverse process where the byte stream is used to recreate the actual Java object in memory. This mechanism is used to persist the object.
              <br>The ObjectInputStream class contains readObject() method for deserializing an object.</p>
<br><br>    <h1 style="font-size: 35px">Advantages of serialization</h1>
              ...
              <br>
              <div style="align-self: center; padding-left: 100px"><img src="https://media.geeksforgeeks.org/wp-content/cdn-uploads/gq/2016/01/serialize-deserialize-java.png" ></div>
              <br><br>    <h1 style="font-size: 35px">Advantages of serialization</h1>
              <br>
              <ul style="list-style-type:circle; padding-left:5em">
                <li style="font-size: 18px">
            ...
            <br><br>
              <div style="align-self: center; padding-left: 100px"><img src="https://media.geeksforgeeks.org/wp-content/uploads/serialization-5.jpg" ></div>
              <br><br>

            <p style="font-size: 18px">Only the objects of those classes can be serialized which are implementing java.io.Serializable interface.<br>
Serializable is a marker interface (has no data member and method). It is used to “mark” java classes so that objects of these classes may get certain capability. Other examples of marker interfaces are:- Cloneable and Remote.  </p><br>

              <h1 style="font-size: 35px">Points to remember</h1>
                <br>
              <ul  style="list-style-type:circle; padding-left:5em">
                <li style="font-size: 18px">
...
<br><br>
         <hr>
           ...
           <a href="buffered.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="ObjectInputOutput.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
