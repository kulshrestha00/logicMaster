...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <!-- Checking Starts from here.....Please check-->
    <a href=" <%
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Introduction to Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>

            <p style="font-size: 18px">Java is a high-level programming language originally developed by Sun Microsystems and released in 1995. Java runs on a variety of platforms, such as Windows, Mac OS, and the various versions of UNIX. This tutorial gives a complete understanding of Java. This reference will take you through simple and practical approaches while learning Java Programming language.</p>
            <br>
            <h1 style="font-size: 35px">WHY TO LEARN JAVA  ?</h1>
            <p style="font-size: 18px">Java is a MUST for students and working professionals to become a great Software Engineer specially when they are working in Software Development Domain. I will list down some of the key advantages of learning Java Programming:</p>
            <br>
            <ul style="list-style-type:square; padding-left:5em">
                <li>
                  <u><b style="font-size: 18px">Object Oriented </b> </u><p style="font-size: 18px">In Java, everything is an Object. Java can be easily extended since it is based on the Object model.</p> 
                </li>
                <li>
                    <u><b style="font-size: 18px">Platform Independent</b></u> <p style="font-size: 18px">Unlike many other programming languages including C and C++, when Java is compiled, it is not compiled into platform specific machine, rather into platform independent byte code. This byte code is distributed over the web and interpreted by the Virtual Machine (JVM) on whichever platform it is being run on.</p>
                </li>
                <li>
                  <u><b style="font-size: 18px">Simple </b> </u><p style="font-size: 18px">Java is designed to be easy to learn. If you understand the basic concept of OOP Java, it would be easy to master.</p> 
                </li>
                <li>
                  <u><b style="font-size: 18px">Secure </b> </u><p style="font-size: 18px">With Java's secure feature it enables to develop virus-free, tamper-free systems. Authentication techniques are based on public-key encryption.</p> 
                </li>
                <li>
                  <u><b style="font-size: 18px">Architecture-neutrality </b> </u><p style="font-size: 18px">Java compiler generates an architecture-neutral object file format, which makes the compiled code executable on many processors, with the presence of Java runtime system.</p> 
                </li>
                <li>
                  <u><b style="font-size: 18px">Portable </b> </u><p style="font-size: 18px">Being architecture-neutral and having no implementation dependent aspects of the specification makes Java portable. Compiler in Java is written in ANSI C with a clean portability boundary, which is a POSIX subset.</p> 
                </li>
                <li>
                <u><b style="font-size: 18px">Robust </b> </u><p style="font-size: 18px">Java makes an effort to eliminate error prone situations by emphasizing mainly on compile time error checking and runtime checking.</p> 
                </li>
            </ul>
            <br>
             <div>
            <h1 style="font-size: 35px">HISTORY OF JAVA </h1>
            <p style="font-size: 18px">
            ...
            </p> <div style="text-align: left; width: 50%; margin-left: 0; float: left;"> 
        <ul style="list-style-type:circle;padding-left:5em">
        <li> <p style="font-size: 18px"> James Gosling, Mike Sheridan, and Patrick Naughton initiated the Java language project in June 1991. The small team of sun engineers called Green Team.</p></li>
         <li><p style="font-size: 18px"> Initially designed for small, embedded systems in electronic appliances like set-top boxes.</li>
         </p></ul></div><div style="text-align: right; width: 30%; margin-right: 0; float: right; padding-right: 100px;"><img src="https://static.javatpoint.com/images/j1.jpg" ></div></div>
         <br>
         <br>
           <br>
           <br>
         ...
         <br>
            ...
            <h1 style="font-size: 35px; "> PREREQUISITES</h1> 
           <p style="font-size: 18px"> Before you start practicing various types of examples given in this reference, we assume that you are already aware about computer programs and computer programming languages.</p>
    <hr style="color: black">
         <br>
         <br>
         <br>
           ...
           <a href="oop.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
