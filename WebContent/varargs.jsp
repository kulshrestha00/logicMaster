 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Varargs in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/9EzGgz5th_s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<br>
            <p style="font-size: 18px">The varrags allows the method to accept zero or muliple arguments. Before varargs either we use overloaded method or take an array as the method parameter but it was not considered good because it leads to the maintenance problem. If we don't know how many argument we will have to pass in the method, varargs is the better approach.</p><br>
           
           
                      <br>
            <h1 style="font-size: 35px">Important Points</h1>
            <p style="font-size: 18px">1.) Vararg Methods can also be overloaded but overloading may lead to ambiguity.</p><br>
            <p style="font-size: 18px">2.)There can be only one variable argument in a method.
            </p><br>
            <p style="font-size: 18px">3.) Variable argument (varargs) must be the last argument. </p><br>
            <p style="font-size: 18px">4.)</p>Prior to JDK 5, variable length arguments could be handled into two ways : One was using overloading, other was using array argument.<br>
           
            
            <br>
            <h1 style="font-size: 35px">SYNTAX :-</h1><br>
            <p style="font-size: 18px">public static void fun(int ... a) </p>
            <p style="font-size: 18px">{</p>
            <p style="font-size: 18px">// method body</p><br>
            <p style="font-size: 18px">}</p><br><br>
            <p style="font-size: 18px">This syntax tells the compiler that fun( ) can be called with zero or more arguments. As a result, here a is implicitly declared as an array of type int[]. Below is a code snippet for illustrating the above concept :</p>
         ...
         <br>
           ...
           <a href="arrays.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="package.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
