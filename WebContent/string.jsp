...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="string.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >String in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
	<!-- Video Tag-->
           <iframe width="560" height="315" src="https://www.youtube.com/embed/zvA4fzyH1gs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <p style="font-size: 18px">Strings in Java are Objects that are backed internally by a char array. Since arrays are immutable(cannot grow), Strings are immutable as well. Whenever a change to a String is made, an entirely new String is created.</p><br>
            <p style="font-size: 18px">Below is the basic syntax for declaring a string in Java programming language.</p><br><br>
            <p style="font-size: 25px">SYNTEX :-</p><br>
            <P style="font-size: 18px">String_Type string_variable = "sequenceofstring";</P>
            <p style="font-size: 25px">EXAMPLE :- </p><br>
            <P style="font-size: 18px">String str ="Geeks";</P><br><br>
            
            <h1 style="font-size: 35px">Interfaces and Classes in Strings in Java</h1><br>
             
<u>CharBuffer:</u> This class implements the CharSequence interface. This class is used to allow character buffers to be used in place of CharSequences. An example of such usage is the regular-expression package java.util.regex.</p><br>
            <p style="font-size: 18px"><u>String:</u> String is a sequence of characters. In java, objects of String are immutable which means a constant and cannot be changed once created</p><br>
             ...
             <p style="font-size: 25px">Creating a String</p><br>
             <p style="font-size: 18px"><u>Reusability:</u>There are two ways to create string in Java:</p><br><br>
           <h1 style="font-size: 25px">String literal</h1><br>
           <p style="font-size: 18px">String s = "AnyThing";</p><br>
           <p style="font-size: 25px">Using new keyword</p><br>
           <p style="font-size: 18px">String s = new String ("Anything");</p><br>
           ...
           <p style="font-size: 18px">StringTokenizer: StringTokenizer class in Java is used to break a string into tokens</p><br>
         ...
         <br>
           ...
           <a href="overloadAndOverride.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="builderAndBuffer.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
