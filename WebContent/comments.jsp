...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="comments.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              Comments in java
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Comments In Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
...
<p style="font-size: 33px"><b>Types Of Comment</b></p>

<br>

<h2><b>There are three types of comments in java.</b></h2>
<br>
<ul style="list-style-type: square; font-size: 22px">
  <li>
    Single Line Comment
  </li>
   <li>
...
<br>
<img src="https://static.javatpoint.com/images/java-types-of-comments.png"><br>
<p style="font-size: 24px"><b>1) Java Single Line Comment</b></p><br>
<h2>The single line comment is used to comment only one line.</h2><br>
<p style="font-size: 19px"><b>Syntax</b></p><br>
<table bgcolor=#d3d3d3><th>//This is single line comment</th></table>
<br>
...
<h2><b>Output:</b></h2>
<br>
<h2><p style="font-size: 24px"><b>2) Java Multi Line Comment</b></p><br>
The multi line comment is used to comment multiple lines of code.</h2>
<h3><b>Syntax:</b></h3>
<br>
<table bgcolor=#d3d3d3><th><pre>
  /* 
...
<br>
<table bgcolor=#d3d3d3><th>10</th></table><br>
<p style="font-size: 24px"><b>3) Java Documentation Comment</b></p>
<h2>he documentation comment is used to create documentation API. To create documentation API, you need to use javadoc tool.</h2><br>
<h3><b>Syntax</b></h3><br>
<table bgcolor=#d3d3d3><th><pre>
/** 
This  
...
<br>
<strong>Compile it by javac tool</strong>
<br>
<table bgcolor=#d3d3d3><th><pre>
javac Calculator.java
</pre></th></table>
<br>
<strong>Create Documentation API by javadoc tool:
...
<br>
<p style="font-size: 19px">Now, there will be HTML files created for your Calculator class in the current directory. Open the HTML files and see the explanation of Calculator class provided through documentation comment.</p>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="breakContinue.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="constructors.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
