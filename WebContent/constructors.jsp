...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="constructors.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              Constructors
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Constructors in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
        ...
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <p style="font-size: 18px">A constructor in Java is a special method that is used to initialize objects. The constructor is called when an object of a class is created. It can be used to set initial values for object attributes </p><br>
           <p style="font-size: 18px">It is a special type of method which is used to initialize the object.</p><br>
           <p style="font-size: 18px">Every time an object is created using the new() keyword, at least one constructor is called.</p><br>
                      <br>
            <h1 style="font-size: 35px">Types of constructors</h1>
            <p style="font-size: 18px">1.) Default Constructor(no-Argument Constructor)</p>
            <p style="font-size: 18px">2.) Parameterized constructor
            </p>
            <br>
            <br>
            <h1 style="font-size: 35px">Default Constructor(no-Argument Constructor)</h1><br>
            <p style="font-size: 18px">When a Constructor doesn't have any constructor then it is called default constructor</p><br>
            <p style="font-size: 18px">SYNTEX :-</p>
            <p style="font-size: 18px">class_name(){} </p><br><br>
            <h1 style="font-size: 35px">Parameterized constructor</h1><br>
             <p style="font-size: 18px">A constructor is called Parameterized Constructor when it accepts a specific number of parameters. To initialize data members of a class with distinct values.

             </p><br>
              <p style="font-size: 16px">Why use the parametrized constructor?</p>
            <p style="font-size: 16px">Ans- The parameterized constructor is used to provide different values to distinct objects. However, you can provide the same values also.</p>
            
         <br>
         <br>
         <br>
                     <!-- This should not be in the front page but for example i am writing this here for reference  -->
           <a href="comments.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="static.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
