...
<!-- Another Header -->
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >StringTokenizer in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
            <!-- Video Tag -->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/DxXqqtecMW0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <br>
            
             
            <p style="font-size: 18px"> The java.util.StringTokenizer class allows you to break a string into tokens. It is simple way to break string.</p><br>
            <p style="font-size: 18px"> It doesn't provide the facility to differentiate numbers, quoted strings, identifiers etc. like StreamTokenizer class. We will discuss about the StreamTokenizer class in I/O chapter.
              
             <p style="font-size: 25px">Constructors of StringTokenizer class</p><br>
         
           <p style="font-size: 18px">There are 3 constructors defined in the StringTokenizer class.</p><br><br>
 ...
 <table>
  ...
  <tr>
    <td>StringTokenizer(String str</td>
    <td>creates StringTokenizer with specified string.</td>
    
  </tr>
  <tr>
    <td>StringTokenizer(String str, String delim)</td>
    <td>creates StringTokenizer with specified string and delimeter.</td>
    
  </tr>
  <tr>
    <td>StringTokenizer(String str, String delim, boolean returnValue)</td>
    <td>creates StringTokenizer with specified string, delimeter and returnValue. If return value is true, delimiter characters are considered to be tokens. If it is false, delimiter characters serve to separate tokens.</td>
...
<p style="font-size: 25px">Methods of StringTokenizer class</p><br>      
           
 <p style="font-size: 18px">The 6 useful methods of StringTokenizer class are as follows:</p><br><br> 
 <table>
  <tr>
    <th>
Public method</th>
  ...
  <tr>
    ...
    <td>String nextToken()</td>
           ...
           <a href="builderAndBuffer.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="date.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
