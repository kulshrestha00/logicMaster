...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="association.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              Association
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Association</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/HINmbq_CpVk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
</div>

            <br>
           
            <p style="font-size: 18px">Association refers to the relationship between multiple objects.
             It refers to how objects are related to each other and how they are using each other's functionality. 
             Composition and aggregation are two types of association.(has-a relationship)
</p>
           <br>
            
    
                <div>
                <h1 style="font-size: 35px">Composition:</h1><br><br>
                <p style="font-size: 18px">The composition is the strcong type of association. An association is said 
                to be composition if an Object owns another object and another object cannot exist without the owner object.
                 Consider the case of Human having a heart. Here Human object contains the heart and heart cannot exist without Human.
                </p><br><br>
                <h1 style="font-size: 35px">Example</h1><br><br>
                <div style="background-color:grey">
                 <p style="font-size: 18px">
                //Car must have Engine<br>
public class Car {<br>
   //engine is a mandatory part of the car<br>
   private final Engine engine;<br>
<br>
   public Car () {<br>
...
class Engine {}<br>
                ...
                <h1 style="font-size: 35px">Aggregation:</h1><br><br>
                <p style="font-size: 18px">Aggregation is a weak association. An association is said to be aggregation 
                if both Objects can exist independently. For example, a Team object and a Player object. The team contains 
                multiple players but a player can exist without a team.
                </p>
                <br><br>
                <h1 style="font-size: 35px">Example</h1><br><br>
                <div style="background-color:grey">
...
<br>public class Team {<br>      
   //players can be 0 or more<br>
...
<img length="550" width="700" src="https://data-flair.training/blogs/wp-content/uploads/sites/2/2018/05/Types-of-association-in-java-1280x720.jpg">           
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="inheritance.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="binding.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
