...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="static.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Static keyword in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
            <!-- Adding video to the content -->
        <iframe width="560" height="315" src="https://www.youtube.com/embed/PHsezZuGTX8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <p style="font-size: 18px"> The static keyword in Java is used for memory management mainly. We can apply static keyword with variables, methods, blocks and nested classes. The static keyword belongs to the class than an instance of the class.</p><br>
           <p style="font-size: 18px">1.) Variable(Class variable)</p><br>
           <p style="font-size: 18px">2.) Method (class Method)</p><br>
           <p style="font-size: 18px">Block</p><br>
           <p style="font-size: 18px">Nested class</p><br>
           
                      <br>
            <h1 style="font-size: 35px">* Java Static variable</h1>
            <p style="font-size: 18px">If you declare any variable as static, it is known as a static variable.</p><br>
            <p style="font-size: 18px">1.) The static variable can be used to refer to the common property of all objects (which is not unique for each object), for example, the company name of employees, college name of students, etc.</p><br>
            <p style="font-size: 18px">2.) The static variable gets memory only once in the class area at the time of class loading.
            </p><br>
            
            <br>
            <h1 style="font-size: 35px">* Java Static methods</h1><br>
            <p style="font-size: 18px">If you apply static keyword with any method, it is known as static method.</p><br>
            <p style="font-size: 18px">1.) A static method belongs to the class rather than the object of a class.</p><br>
            <p style="font-size: 18px">2.) A static method can access static data member and can change the value of it.</p><br><br>
            
            <h1 style="font-size: 35px">* Java Static Block</h1><br>
            <p style="font-size: 18px">1.) Is used to initialize the static data member.</p><br>
            <p style="font-size: 18px">2.) It is executed before the main method at the time of classloading.</p><br><br>
            <h1 style="font-size: 35px">* Java Static Nasted Class</h1><br>
            <p style="font-size: 18px"> A static class i.e. created inside a class is called static nested class in java. It cannot access non-static data members and methods. It can be accessed by outer class name.</p><br>
            <p style="font-size: 18px">1.) It can access static data members of outer class including private.</p><br>
             <p style="font-size: 18px">2.) Static nested class cannot access non-static (instance) data member or method. </p><br>
         ...
         <br>
           ...
           <a href="constructors.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="this.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
