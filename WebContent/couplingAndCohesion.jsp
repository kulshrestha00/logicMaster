...
<head>
    ...
    <title>couplingAndCohesion.</title>
...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="couplingAndCohesion.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Coupling And Cohesion.</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/eUmWIlTIyro" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

            <br>
            <div>
                <h1 style="font-size: 35px">Coupling:</h1><br><br>
                <p style="font-size: 18px">It refers to how related or dependent two classes/modules are towards 
                each other.
                </p><br><br>
               

                <h1 style="font-size: 35px">Cohesion:</h1><br><br>
                <p style="font-size: 18px">It refers to what the class can do. Low cohesion would mean that the class does 
                a great variety of actions, it is unfocused on what it should do. High cohesion means that the class is focused on what it should be doing.
...
<img length="500" width="650" src="https://image.slidesharecdn.com/couplingandcohesion-161119093019/95/coupling-and-cohesion-in-software-engineering-70-638.jpg?cb=1479548104">           
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="binding.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="bestPractice.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
