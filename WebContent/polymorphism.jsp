...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href=polymorphism.jsp class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              polymorphism
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Polymorphism</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/jg4MpYr1TBc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            
</div>

            <br>
           
            <p style="font-size: 18px"><b>The word polymorphism means</b> having many forms
Real life example of polymorphism: A person at the same time can have different characteristic.
Like a man at the same time is a father, a husband, an employee. So the same person 
posses different behaviour in different situations. This is called polymorphism.
</p>
           <br>
            
    
                <div>
                <h1 style="font-size: 35px">Types of polymorphism.</h1><br><br>
                <p style="font-size: 18px"><b>Complie time.</b><br>
                It is also known as static polymorphism. This type of polymorphism is achieved by 
                function overloading.
                </p>
                <p style="font-size: 14px"><b>Method Overloading</b>: When there are multiple functions with same name but different parameters then these functions 
                are said to be overloaded. Functions can be overloaded by change in number of arguments or/and change in type of arguments.<br>
...
class Main { 
    ...
    { 
        ...
        System.out.println(MultiplyFun.Multiply(5.5, 6.3)); 
               ...
               <b>Runtime polymorphism</b>: It is also known as Dynamic Method Dispatch.
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="abstraction.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="inheritance.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
