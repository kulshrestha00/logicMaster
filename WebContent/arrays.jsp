...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="varargs.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Aarays in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
<iframe width="560" height="315" src="https://www.youtube.com/embed/dRrjjotgniA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>           
            <p style="font-size: 18px">Java array is an object which contains elements of a similar data type. Additionally, The elements of an array are stored in a contiguous memory location. It is a data structure where we store similar elements. We can store only a fixed set of elements in a Java array.</p><br>
           <p style="font-size: 18px">Array in Java is index-based, the first element of the array is stored at the 0th index, 2nd element is stored on 1st index and so on.</p><br>
           
                      <br>
            <h1 style="font-size: 35px">Types of Array in java</h1>
            <p style="font-size: 18px">There are two types of array in java</p><br>
            <p style="font-size: 18px">1.) Single Dimensional Array
            </p><br>
            <p style="font-size: 18px">2.) Multidimensional Array in java </p><br>
           
            
            <br>
            <h1 style="font-size: 35px">SYNTAX :-</h1><br>
            <p style="font-size: 18px">dataType[] arr; (or)  {</p>
            <p style="font-size: 18px">dataType []arr; (or)</p>
            <p style="font-size: 18px">dataType arr[];</p><br>
            <h1 style="font-size: 35px">Instantiation of an Array in Java</h1><br>
            <p style="font-size: 18px"> arrayRefVar=new datatype[size];</p><br><br>
           
         <br>
         <br>
         <br>
                     <!-- This should not be in the front page but for example i am writing this here for reference  -->
           <a href="this.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="varargs.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
