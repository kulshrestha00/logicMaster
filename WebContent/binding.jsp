...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="binding.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Dynamic And Static Binding.</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/W6s7RZo06nA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
</div>

            <br>
           
            <p style="font-size: 18px"><b>Binding</b> is a mechanism creating link between method call and method actual implementation.
             As per the polymorphism concept in Java , object can have many different forms. Object forms can be 
             resolved at compile time and run time. If linking between method call  and method implementation is resolved at
              compile time then we call it static binding or  If it is resolved at run time then it dynamic binding. 
              Dynamic binding uses object to resolve binding but static binding use type of the class and fields. 
</p>
           <br>
            
    
                <div>
                <h1 style="font-size: 35px">Dynamic Binding</h1><br><br>
                <p style="font-size: 18px">When type of the object is determined at run-time, it is known as dynamic binding.
                </p><br><br>
                <
                
                <h1 style="font-size: 35px">Static Binding</h1><br><br>
                <p style="font-size: 18px">When type of the object is determined at compiled time(by the compiler), it is known as static binding.
                 If there is any private, final or static method in a class, there is static binding.
                </p>
                <br><br>
                <h1 style="font-size: 35px">Difference B/W Static And Dynamic Binding</h1><br><br>
                
<table  class="table table-bordered"><thead><tr><th>Sr. No.<br></th>
<th style="text-align:center;">Key<br></th><th style="text-align:center;">Static Binding<br></th>
<th style="text-align:center;">Dynamic Binding<br></th></tr></thead><tbody><tr class="c30">
<td class="c19"  colspan="1" rowspan="1"><p class="c3"><span class="c2">1</span></p></td>
<td class="c35" colspan="1" rowspan="1"><p class="c3"><span class="c2">Basic&nbsp;</span></p></td>
<td class="c24" colspan="1" rowspan="1"><p class="c7"><span class="c2">It is resolved at compile time&nbsp;</span></p></td>
<td class="c10" colspan="1" rowspan="1"><p class="c7"><span class="c2">It is resolved at run time&nbsp;</span></p></td>
</tr><tr class="c4"><td class="c19" colspan="1" rowspan="1"><p class="c3"><span class="c2">2</span></p></td>
<td class="c35" colspan="1" rowspan="1"><p class="c7"><span class="c2">&nbsp; &nbsp; &nbsp; &nbsp;Resolve-mechanism &nbsp;</span></p>
</td><td class="c24" colspan="1" rowspan="1"><p class="c7"><span class="c2">&nbsp;static binding use type of the class and fields</span></p></td>
<td class="c10" colspan="1" rowspan="1"><p class="c7"><span class="c2">Dynamic binding uses object to resolve binding&nbsp;</span></p></td>
</tr><tr class="c14"><td class="c19" colspan="1" rowspan="1"><p class="c3"><span class="c2">3</span></p></td>
<td class="c35" colspan="1" rowspan="1"><p class="c3"><span class="c2">Example&nbsp;</span></p></td>
<td class="c24" colspan="1" rowspan="1"><p class="c7"><span class="c2">Overloading is an example of static binding&nbsp;</span></p></td>
<td class="c10" colspan="1" rowspan="1"><p class="c7"><span class="c2">Method overriding is the example of Dynamic binding&nbsp;</span></p></td>
</tr><tr class="c14"><td class="c19" colspan="1" rowspan="1"><p class="c3">
<span class="c2">4.</span></p></td><td class="c35" colspan="1" rowspan="1"><p class="c3"><span class="c2">Type of Methods&nbsp;</span></p></td>
<td class="c24" colspan="1" rowspan="1"><p class="c7">
<span class="c2">private, final and static methods and variables uses static binding.</span></p></td>
<td class="c10" colspan="1" rowspan="1"><p class="c7"><span class="c2">Virtual methods use dynamic binding&nbsp;</span></p></td></tr>
</tbody></table>
<br>
<br>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="association.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="couplingAndCohesion.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
