...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="forEach.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              FOR EACH Loop
            </a>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UcsoLgBaGmg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<p style="font-size: 33px"><b>Java For-each Loop | Enhanced For Loop</b></p>
<br>
<p style="font-size: 19px"> The Java for-each loop or enhanced for loop is introduced since J2SE 5.0. It provides an alternative approach to traverse the array or collection in Java. It is mainly used to traverse the array or collection elements. The advantage of the for-each loop is that it eliminates the possibility of bugs and makes the code more readable. It is known as the for-each loop because it traverses each element one by one.</p><br>
<p style="font-size: 19px">The drawback of the enhanced for loop is that it cannot traverse the elements in reverse order. Here, you do not have the option to skip any element because it does not work on an index basis. Moreover, you cannot traverse the odd or even elements only.</p><br>
<p style="font-size: 19px">But, it is recommended to use the Java for-each loop for traversing the elements of array and collection because it makes the code readable</p><br>
<p style="font-size: 24px"><b>Advantages</b></p><br>
<table bgcolor=#d3d3d3><th>
  <ul style="list-style-type: circle;">
    <li>It makes the code more readable.</li>
    <li>It eliminates the possibility of programming errors.</li>
  </ul>
</th></table>
<br>
<p style="font-size: 24px"><b>Syntax</b></p><br>
<p style="font-size: 19px"><b>The syntax of Java for-each loop consists of data_type with the variable followed by a colon (:), then array or collection.</b></p><br>
<br>
<table><th><pre>The syntax of Java for-each loop consists of data_type with the variable followed by a colon (:), then array or collection.</pre></th></table>
<table bgcolor=#d3d3d3><th><pre>for(data_type variable : array | collection){  
//body of for-each loop  
} </pre> </th></table>
<br>
<p style="font-size: 24px"><b>How it works?</b></p>
<br>
<p style="font-size: 19px">The Java for-each loop traverses the array or collection until the last element. For each element, it stores the element in the variable and executes the body of the for-each loop.</p><br>
<p style="font-size: 24px">
  For-each loop Example: Traversing the array elements
</p><br>
<table bgcolor=#d3d3d3><th><pre>//An example of Java for-each loop  
...
<b>Let us see another of Java for-each loop where we are going to total the elements.</b>
...
<br>
<p style="font-size: 24px">For-each loop Example: Traversing the collection elements</p><br>
<table bgcolor=#d3d3d3><th><pre>
  import java.util.*;  
...
<br>
<h2>Output:</h2>
<table bgcolor=#d3d3d3><th><pre>vimal
sonoo
ratan</pre></th></table>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="doWhile.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="breakContinue.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
