...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="file.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <a href="character.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >File class in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/SslMi6ptwH8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <br>
            <h1 style="font-size: 35px">File object creation</h1>
            <p style="font-size: 18px">A File object is created by passing in a String that represents the name of a file, or a String or another File object. For example,
              <br>
              <b>      File a = new File("/usr/local/bin/Main");       </b><br>
            ...
            <ul style="list-style-type:square; padding-left:5em">
              <li style="font-size: 18px">
               <b> boolean canExecute() </b>: Tests whether the application can execute the file denoted by this abstract pathname.
              </li>
              <li style="font-size: 18px">
               <b> boolean canRead() </b>: Tests whether the application can read the file denoted by this abstract pathname.
              </li>
              <li style="font-size: 18px">
                <b> boolean canWrite() </b> : Tests whether the application can modify the file denoted by this abstract pathname.
              </li>
              <li style="font-size: 18px">
               <b> int compareTo(File pathname)</b> : Compares two abstract pathnames lexicographically.
              </li>
              <li style="font-size: 18px">
               <b> boolean createNewFile() </b>: Atomically creates a new, empty file named by this abstract pathname .
              </li>
              <li style="font-size: 18px">
               <b> boolean delete() </b>: Deletes the file or directory denoted by this abstract pathname.
              </li>
              <li style="font-size: 18px">
                <b> boolean equals(Object obj) </b>: Tests this abstract pathname for equality with the given object.
              </li>
              <li style="font-size: 18px">
               <b> boolean exists() </b>: Tests whether the file or directory denoted by this abstract pathname exists.
              </li>
              <li style="font-size: 18px">
               <b> String getAbsolutePath()</b> : Returns the absolute pathname string of this abstract pathname.
              </li>
              <li style="font-size: 18px">
               <b> String getName() </b>: Returns the name of the file or directory denoted by this abstract pathname.
              </li>
              <li style="font-size: 18px">
               <b> File getParentFile()</b> : Returns the abstract pathname of this abstract pathname's parent.
              </li>
              <li style="font-size: 18px">
              <b> boolean isFile() </b>: Tests whether the file denoted by this abstract pathname is a normal file.  
              </li>
              <li style="font-size: 18px">
               <b> boolean isHidden()</b> : Tests whether the file named by this abstract pathname is a hidden file.
              </li>
              
              <li style="font-size: 18px">
                <b>String[] list() </b>: Returns an array of strings naming the files and directories in the directory .
              </li>
              
              <li style="font-size: 18px">
               <b> File[] listFiles()</b> : Returns an array of abstract pathnames denoting the files in the directory.
              </li>
              <li style="font-size: 18px">
               <b> boolean mkdir() </b>: Creates the directory named by this abstract pathname.
              </li>
              <li style="font-size: 18px">
               <b> boolean setReadable(boolean readable)</b> : A convenience method to set the owner's read permission.
              </li>
              <li style="font-size: 18px">
               <b> boolean setReadOnly() </b>: Marks the file or directory named so that only read operations are allowed.
              </li>
              <li style="font-size: 18px">
               <b> boolean setWritable(boolean writable)</b> : A convenience method to set the owner’s write permission.
              </li>
              <li style="font-size: 18px">
               <b> String toString() </b>: Returns the pathname string of this abstract pathname.
              </li>
              <li style="font-size: 18px">
               <b> URI toURI() </b>: Constructs a file URI that represents this abstract pathname.
              </li>
            </ul>
            </p>
<br><br>
         <hr>
           ...
           <a href="character.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="readerAndWriter.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
