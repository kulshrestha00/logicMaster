...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="abstraction.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              Abstraction
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Abstraction</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/zZq_XDhU-rc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe></div>

            <br>
           
            <p style="font-size: 18px">Data <b>abstraction</b> is the process of hiding 
...
Abstraction can be achieved with either abstract classes or interfaces (which you will learn more about in the next chapter).
           ...
           <br>
                ...
                <div>
                <h1 style="font-size: 35px">Abstract keyword.</h1><br><br>
                <p style="font-size: 18px">
                 
The abstract keyword is a non-access modifier, used for abstraction in classes and methods</p>
...
<br>
<b>Abstract method</b>: can only be used in an abstract class, and it does not have a body. The body is provided by the subclass (inherited from).
                
                <h1 style="font-size: 35px">Example of Abstraction in Java.</h1><br>
                <div style="background-color: grey; width: 500px; height: 200px;padding-left: 10px">
  ...
  public void sleep() {
    System.out.println("Zzz");
                 ...
                 <br>
                 <h1 style="font-size: 35px">Features of abstract class in Java.</h1>
                 <p style="font-size: 18px">
<b>An</b> abstract class cannot be instantiated.

<b>An</b> abstract class may contain abstract methods and accessors.

<b>It</b> is not possible to modify an abstract class with the 
sealed modifier because the two modifiers have opposite meanings. 
The sealed modifier prevents a class from being inherited and 
the abstract modifier requires a class to be inherited.

<b>A</b> non-abstract class derived from an abstract class must include 
actual implementations of all inherited abstract methods and accessors.

 </p>
<br>
<h1 style="font-size: 35px">Features of abstract methods in Java.</h1>
<p style="font-size: 18px">                 
<b style="font-size: 18px">An</b> abstract method is implicitly a virtual method.

<b>Abstract</b> method declarations are only permitted in abstract classes.

<b>Because</b> an abstract method declaration provides no actual implementation, 
there is no method body;
the method declaration simply ends with a semicolon 
and there are no curly braces ({ }) following the signature.                  
</p>                 
</div>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="encapsulation.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="polymorphism.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
