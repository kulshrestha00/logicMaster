...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="tokenizer.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <a href="builderAndBuffer.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/oYcb0N1YfVw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
            </iframe>
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >StringBuffer and StringBuilder in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            ...
            <h1 style="font-size: 35px">Stringbuffer class in java</h1><br>
             
            <p style="font-size: 18px"><u>String:</u> String is a sequence of characters. In java, objects of String are immutable which means a constant and cannot be changed once created</p><br>
            <p style="font-size: 18px">StringBuffer is a peer class of String that provides much of the functionality of strings. String represents fixed-length, immutable character sequences while StringBuffer represents growable and writable character sequences.</p><br>
              <p style="font-size: 18px">StringBuffer may have characters and substrings inserted in the middle or appended to the end. It will automatically grow to make room for such additions and often has more characters preallocated than are actually needed, to allow room for growth.</p><br>
             <p style="font-size: 25px">Creating a String</p>
         
           <p style="font-size: 18px">StringBuffer: StringBuffer is a peer class of String that provides much of the functionality of strings. String represents fixed-length, immutable character sequences while StringBuffer represents growable and writable character sequences.</p><br>
           
           <h1 style="font-size: 35px">StringBuilder class in java</h1><br><br>
           <p style="font-size: 18px">StringBuilder: The StringBuilder in Java represents a mutable sequence of characters. Since the String Class in Java creates and immutable sequence of characters, the StringBuilder class provides an alternate to String Class, as it creates a mutable sequence of characters.</p><br>
           <p style="font-size: 18px">Java StringBuilder class is used to create mutable (modifiable) string. The Java StringBuilder class is same as StringBuffer class except that it is non-synchronized. It is available since JDK 1.5.</p>
            <p style="font-size: 25px">Constructor</p><br><br>
            <p style="font-size: 18px">StringBuilder() :creates an empty string Builder with the initial capacity of 16.</p><br>
            <p style="font-size: 18px">StringBuilder(String str) :creates a string Builder with the specified string.</p><br>
            <p style="font-size: 18px">StringBuilder(int length) :creates an empty string Builder with the specified capacity as length.</p>
            
          <p style="font-size: 25px">Method</p><br><br>
           <p style="font-size: 18px"><u>public StringBuilder append(String s)</u> :-is used to append the specified string with this string. The append() method is overloaded like append(char), append(boolean), append(int), append(float), append(double) etc.</p><br>
            <p style="font-size: 18px"><u>public StringBuilder insert(int offset, String s)</u> :-is used to insert the specified string with this string at the specified position. The insert() method is overloaded like insert(int, char), insert(int, boolean), insert(int, int), insert(int, float), insert(int, double) etc.</p><br>
            <p style="font-size: 18px"><u>public StringBuilder replace(int startIndex, int endIndex, String str)</u> :-is used to replace the string from specified startIndex and endIndex.</p>
             <p style="font-size: 18px"><u>public StringBuilder delete(int startIndex, int endIndex)</u> :-is used to delete the string from specified startIndex and endIndex.</p> 
         <br>
         <br>
         <br>
                     <!-- This should not be in the front page but for example i am writing this here for reference  -->
           <a href="string.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="tokenizer.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
