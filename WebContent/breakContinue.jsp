...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        <div class="p-6">
            <p class="text-white text-3xl font-semibold  hover:text-gray-300">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="breakContinue.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              break and continue
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Break & Continue In Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/VJnSheKQc4U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
</div>
<p style="font-size: 33px"><b>Break (keyword)</b></p>
<br>
<p style="font-size: 19px">The break statement in Java programming language has the following two usages −</p>
<br>
...
<h2><b>Syntax</b></h2>
<br>
<p style="font-size: 22px">The syntax of a break is a single statement inside any loop −</p>
<br>
<table bgcolor=#d3d3d3><th>break;</th></table><br>
...
<br>
<p style="font-size: 19px">The continue keyword can be used in any of the loop control structures. It causes the loop to immediately jump to the next iteration of the loop.</p>
<ul style="list-style-type: square; font-size: 19px">
  <li>In a for loop, the continue keyword causes control to immediately jump to the update statement.</li>
  <li>In a while loop or do/while loop, control immediately jumps to the Boolean expression.</li>
</ul>
<br>
<h2><b>Syntax</b></h2>
<br>
<table bgcolor=#d3d3d3><th>continue;</th></table>
<h2><b>Example</b></h2>
<br>
<table bgcolor=#d3d3d3>
  <th>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="forEach.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="comments.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
