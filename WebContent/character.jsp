 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/OioUUNlJ8Ng" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Character stream in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
...
<br>
The Reader and Writer classes (abstract) are the super classes of all the character stream classes: classes that are used to read/write character streams. Following are the character array stream classes provided by Java −</p>
            <br>
            <br>
            <img src="https://o7planning.org/en/10173/cache/images/i/14351.gif" >
            <br>
            <br>
  ...
  <thead>
    <tr class="bg-gray-400">
      ...
      <th class="px-4 py-4">Reader </th>
      <th class="px-4 py-4">Writer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td class="border px-4 py-4">BufferedReader  </td>
      <td class="border px-4 py-4">BufferedWriter</td>
      
    </tr>
    <tr >
      <td class="border px-4 py-4">CharacterArrayReader</td>
      <td class="border px-4 py-4">CharacterArrayWriter</td>
     
    </tr>
    <tr>
      <td class="border px-4 py-4">StringReader</td>
      <td class="border px-4 py-4">StringWriter</td>
      
    </tr>
    <tr>
      <td class="border px-4 py-4">FileReader</td>
      <td class="border px-4 py-4">FileWriter</td>
      
    </tr>
    <tr>
      <td class="border px-4 py-4">InputStreamReader</td>
      <td class="border px-4 py-4">InputStreamWriter</td>
    ...
    <tr>
      ...
      <td class="border px-4 py-4">FileWriter</td>
         ...
         <hr>
           ...
           <a href="byte.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="file.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
