...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="queue.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
               QUEUE
            </a>
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Queue in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/PvDoT79oHTs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           ...
           <p>The queue interface is provided in java.util package and it implements the Collection interface. The queue implements FIFO i.e. First In First Out. This means that the elements entered first are the ones that are deleted first.</p><p>A program that demonstrates queue in Java is given as follows &minus;</p><h2>Example</h2><p><a class="demo" href="http://tpcg.io/OU8Azk" rel="nofollow" target="_blank">&nbsp;Live Demo</a></p><pre class="prettyprint notranslate"><br><br>import java.util.LinkedList;
			...
			}</pre><h2>Output</h2><pre class="result notranslate">The queue is: [6, 1, 8, 4, 7]
			The element deleted from the head is: 6
			The queue after deletion is: [1, 8, 4, 7]
			The head of the queue is: 1
			The size of the queue is: 4</pre><br><br><p>Now let us understand the above program.</p><p>Five elements are inserted in the queue. Then the queue is displayed. The code snippet that demonstrates this is given as follows &minus;</p><pre class="result notranslate">Queue&lt;Integer&gt; q = new LinkedList&lt;&gt;();
			q.add(6);
			q.add(1);
			q.add(8);
			q.add(4);
			q.add(7);
			System.out.println(&quot;The queue is: &quot; + q);</pre><p>The element from the head of the queue is deleted and it is displayed. Then the size of the queue is displayed. The code snippet that demonstrates this is given as follows &minus;</p><pre class="result notranslate">int num1 = q.remove();
			System.out.println(&quot;The element deleted from the head is: &quot; + num1);
			System.out.println(&quot;The queue after deletion is: &quot; + q);
			int head = q.peek();
			System.out.println(&quot;The head of the queue is: &quot; + head);
			int size = q.size();
			System.out.println(&quot;The size of the queue is: &quot; + size);</pre>
            <br>
            ...
            <a href="list.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
            <a href="map.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
