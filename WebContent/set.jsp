...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="set.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Java - The Set Interface</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/BeR8AcSu-OU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			...
			<p>A Set is a Collection that cannot contain duplicate elements. It models the mathematical set abstraction.</p>
			...
			<p>The methods declared by Set are summarized in the following table &minus;</p><br><br>
			...
			<td class="ts">1</td>
			<td><p><b>add( )</b></p>
			<p>Adds an object to the collection.</p>
			</td>
			</tr>
			<tr>
			<td class="ts">2</td>
			...
			<td class="ts">3</td>
			<td><p><b>contains( )</b></p>
			<p>Returns true if a specified object is an element within the collection.</p>
			</td>
			</tr>
			<tr>
			<td class="ts">4</td>
			...
			<td class="ts">5</td>
			<td><p><b>iterator( )</b></p>
			<p>Returns an Iterator object for the collection, which may be used to retrieve an object.</p>
			</td>
			</tr>
			<tr>
			<td class="ts">6</td>
			<td><p><b>remove( )</b></p>
			<p>Removes a specified object from the collection.</p>
			</td>
			</tr>
			<tr>
			<td class="ts">7</td>
			...
			<h2>Example</h2>
			<p>Set has its implementation in various classes like HashSet, TreeSet, LinkedHashSet. Following is an example to explain Set functionality &minus;</p>
			<div class="demo-view">
			<a href="http://tpcg.io/D3jUny" target="_blank" class="demo" rel="nofollow"><i class="fa-external-link"></i> Live Demo</a>
			</div>
            ...
            <a href="collection.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
            <a href="list.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
