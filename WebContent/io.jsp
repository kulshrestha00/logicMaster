...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="io.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >IO package in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/QfGVi89AV4c" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <p style="font-size: 18px">
              This package provides for system input and output through data streams, serialization and the file system. Unless otherwise noted, passing a null argument to a constructor or method in any class or interface in this package will cause a NullPointerException to be thrown.</p>
            <br>
            <br>
            <img src="https://flylib.com/books/2/33/1/html/2/files/09fig05.gif">
            <br>
            <br>
            <h1 style="font-size: 35px">Important classes of this package.</h1>
            
            <ul style="list-style-type:circle ; padding-left:5em">
                <li>
                  <u><b style="font-size: 18px">BufferedInputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">BufferedOutputStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">BufferedReader</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">BufferedWriter</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">ByteArrayInputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">ByteArrayOutputStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">CharArrayReader</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">CharArrayWriter</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">Console</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">DataInputStream </b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">DataOutputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">File</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">FileDescriptor</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">FileInputStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">FileOutputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">FilePermission</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">FileReader and FileWriter</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">FilterInputStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">FilterOutputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">FilterReader and FilterWriter</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">InputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">InputStreamReader</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">ObjectInputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">ObjectOutputStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">ObjectStreamClass</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">OutputStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">OutputStreamWriter</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">PipedInputStream </b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">PipedOutputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">PipedReader</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">PipedWriter</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">PrintStream</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">PrintWriter</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">PushbackReader</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">RandomAccessFile- </b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">Reader</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">SerializablePermission</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">StreamTokenizer</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">StringBufferInputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">StringReader</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">StringWriter</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">Writer</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">ZipInputStream class </b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">ZipEntry class</b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">ZipOutputStream</b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">Zip.InflaterInputStream </b> </u>
                </li>
                 <li>
                  <u><b style="font-size: 18px">Zip.DeflaterInputStream </b> </u>
                </li>
                <li>
                  <u><b style="font-size: 18px">Zip.DeflaterOutputStream </b> </u>
                </li>
         ...
         <hr>
           ...
           <a href="synchronization.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="byte.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
