    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="ObjectInputOutput.jsp" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
             ...
             <a href="interfaces.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              Interfaces in java
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Java Interface</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            
             <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/Yaa3QroWe7Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

            <p style="font-size: 18px"> 
             Another way to achieve abstraction in Java, is with interfaces.
<br><br>
An interface is a completely "abstract class" that is used to group related methods with empty bodies:</p>
                <br>
                 <div style="align-self: center; padding-left: 100px"><img src="https://static.javatpoint.com/images/core/typesofinheritance.jpg" ></div>
                <br>
...
<div style="width: 400px; height: 200px; background-color: #D3D3D3; padding-top: 10px; padding-left: 15px">
  <p style="font-size: 18px">
    // interface<br>
interface Animal {<br>
  public void animalSound(); // interface method (does not have a body)<br>
  public void run(); // interface method (does not have a body)<br>
}<br>
  </p>
</div><br>
              <br><br>
...
<br>
<div style="width: 400px; height: 790px; background-color: #D3D3D3; padding-top: 10px; padding-left: 15px">
  <p style="font-size: 18px">
    // Interface<br>
interface Animal {<br>
  public void animalSound(); // interface method (does not have a body)<br>
  public void sleep(); // interface method (does not have a body)<br>
}<br>
<br>
// Pig "implements" the Animal interface<br>
class Pig implements Animal {<br>
  ...
  public void sleep() {<br>
    // The body of sleep() is provided here<br>
...
class MyMainClass {<br>
  ...
  <div style="padding-top: 20px; padding-bottom: 20px; background-color: #fffeb0; padding-left: 20px">
   <h1 style="font-size: 25px">Notes on Interfaces:</h1><br>
  <ul style="list-style-type:circle; padding-left:5em">
  <li style="font-size: 18px">Like abstract classes, interfaces cannot be used to create objects (in the example above, it is not possible to create an "Animal" object in the MyMainClass)
      </li>
      <li style="font-size: 18px">On implementation of an interface, you must override all of its methods
      </li>
      <li style="font-size: 18px">Interface methods are by default abstract and public
      </li>
      <li style="font-size: 18px">Interface attributes are by default public, static and final

      </li>
      <li style="font-size: 18px">Interface methods do not have a body - the body is provided by the "implement" class
      </li>
      <li style="font-size: 18px">An interface cannot contain a constructor (as it cannot be used to create objects)
      </li>
    </ul><br>
     <h1 style="font-size: 25px">Why And When To Use Interfaces?</h1><br>
     <ul style="list-style-type:circle; padding-left:5em">
...
<br><br>
         <hr>
           ...
           <a href="ObjectInputOutput.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="jdbc.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
