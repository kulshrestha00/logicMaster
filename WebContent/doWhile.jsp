...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="doWhile.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              Do While Loop
            </a>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/20zlkN-iHMk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<p style="font-size: 33px"><b>Java do-while Loop</b></p>
<br>

<p style="font-size: 19px">The Java do-while loop is used to iterate a part of the program several times. If the number of iteration is not fixed and you must have to execute the loop at least once, it is recommended to use do-while loop.</p>
<br>
<p style="font-size: 19px">
The Java do-while loop is executed at least once because condition is checked after loop body.</p>
<br>
<h2><b>Syntax:</b></h2>
<table bgcolor=#d3d3d3><th><pre>do{  
//code to be executed  
}while(condition);</pre></th></table>
<br><br>
<img src="https://static.javatpoint.com/cpages/images/dowhile.png">
<br>
<h2><b>
Example:
</b></h2>
...
<br>
<p style="font-size: 24px">Java Infinitive do-while Loop</p>
<br>
<p style="font-size: 16px"><b>If you pass true in the do-while loop, it will be infinitive do-while loop.</b></p><br>
<h2>Syntax:</h2>
<br>
<table bgcolor=#d3d3d3><th><pre>
  do{  
...
<h2><b>Output:</b></h2>
<table bgcolor=#d3d3d3><th><b></b>
infinitive do while loop
infinitive do while loop
infinitive do while loop
ctrl+c
</th></table>
<br>Now, you need to press ctrl+c to exit from the program. 
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="while.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="forEach.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
