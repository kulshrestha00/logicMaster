...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="while.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              While Loop
            </a>
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
           ...
           <pre>
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Loops in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <!-- Video Tag -->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/wtXhu-VS_sE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
           
            <p style="font-size: 34px"><b>While Loop</b>
              <br>
              <br>
              <p style="font-size: 24px"><b>While loop in Java with examples</b></p>
              <br><br>
              <p style="font-size: 19px"> In the last tutorial, we discussed for loop. In this tutorial we will discuss while loop. As discussed in previous tutorial, loops are used to execute a set of statements repeatedly until a particular condition is satisfied.</p><br>
              <br>
              <p style="font-size: 24px"><b>Syntax of while loop</b></p><br>
              <table cellpadding="50px" bgcolor=#d0d0d0>
                <th>
                  <pre>
while(condition)
    {
       statement(s);
                  ...
                  <p style="font-size: 24px"> How while Loop works?</p>
                  <br>
                  <p style="font-size: 19px">In while loop, condition is evaluated first and if it returns true then the statements inside while loop execute. When condition returns false, the control comes out of loop and jumps to the next statement after while loop.</p><br>
                  <table cellpadding="50px" bgcolor=#d0d0d0>
                <th>
                  <p style="font-size: 16px">Note: The important point to note
                   when using while loop is that we need to
              use increment or decrement statement inside while loop so that the loop variable
          ...
          way we can end the execution of while loop otherwise the loop would execute
           indefinitely.
                   ...
                   <img src="https://beginnersbook.com/wp-content/uploads/2015/03/while_loop_java.jpg"><br>
                   <p style="font-size: 24px"><b>Simple while loop example</b></p><br>
                   <table bgcolor=#d0d0d0><th><pre>class WhileLoopExample {
...
<p style="font-size: 24px">Infinite while loop</p><br>
<table bgcolor="#d3d3d3">
  <th>
    <pre>
    ...
    <br>    
<p style="font-size: 19px"><pre>This loop would never end, its an infinite while loop. This &ltisindex&gt &lt/isindex&gt because condition is i>1 which would always be true as we
are incrementing the value of i inside while loop.

Here is another example of infinite while loop:
<br><table style="table-layout: all;" bgcolor="#d3d3d3">
  <th>
    <pre>
  while (true)
    {
statement(s);
    ...
    <br>  
    <p style="font-size: 24px">Example: Iterating an array using while loop</p>
    <br>
    <h2><b>Here we are iterating and displaying array elements using while loop.</b></h2><br>
    <table bgcolor=#D3D3D3><th><pre>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="for.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="doWhile.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
