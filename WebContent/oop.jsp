...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="oop.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >OOPS Concept(Objects And Classes)</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->

            <hr style="color: black">
            <br>
            <br>
           
            <iframe width="560" height="315" src="https://www.youtube.com/embed/bzRp16p48bY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           
            <br>
            <h1 style="font-size: 35px">WHAT IS OOPS  ?</h1>
            ...
            <br>
             <h1 style="font-size: 35px">OOPs Concepts</h1>
             <br>
            <ul style="list-style-type:square; padding-left:5em">
                <li>
                  <u><b style="font-size: 18px">Objects </b> </u><p style="font-size: 18px"></p> 
                </li>
                <li>
                    <u><b style="font-size: 18px">Classes</b></u> <p style="font-size: 18px"></p>
                </li>
                <li>
                  <u><b style="font-size: 18px">Polymorphism </b> </u><p style="font-size: 18px"></p> 
                </li>
                <li>
                  <u><b style="font-size: 18px">Encapsulation</b> </u><p style="font-size: 18px"></p> 
                </li>
                <li>
                  <u><b style="font-size: 18px">Abstraction </b> </u><p style="font-size: 18px"></p> 
                </li>
                <li>
                  <u><b style="font-size: 18px">Inheritance </b> </u><p style="font-size: 18px"></p> 
                </li>
                <li>
                <u><b style="font-size: 18px">Message Passing </b> </u><p style="font-size: 18px"></p> 
                </li>
            </ul>
            <br>
             <div align=left><div>
            <h1 style="font-size: 35px">OBJECTS</h1>
            <p style="font-size: 18px">
               Objects have identity, states and behaviors. Example: A dog has name- Tommy, states - color, name, breed as well as behaviors - wagging the tail, barking, eating. An object is an instance of a class.
               </p></div><br><br>
               <div align="center">
               <img height="400" width="500" src="https://static.javatpoint.com/images/characteristics-of-object.jpg">
            </div></div> 
         <br>
         <br>
           <br>
         ...
         <br>
                  <div align=left><br>
            <h1 style="font-size: 35px; "> CLASSES</h1> 
           <p style="font-size: 18px">  A class is a blueprint from which individual objects are created.
           <br></p>
...
<p style="font-size: 18px"><br>  A class is a blueprint from which individual objects are created.
A <b>class</b> can contain any of the following variable types.

<b>Local variables</b> - Variables defined inside methods, constructors or blocks are called local variables. 
...
<b>Instance variables</b> - Instance variables are variables within a class but outside any method. 
...
A <b>class</b> can have any number of <b>methods</b> to access the value of various kinds of methods.
...
<br>
    ...
    <hr style="color: black">
         ...
         <br>
           ...
           <a href="MainTemp.html"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="jdk.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
