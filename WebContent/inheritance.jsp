...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <a href="overloadAndOverride.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Inheritance in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/_9R_in_7cT4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
            <p style="font-size: 18px">Inheritance in Java is a mechanism in which one object acquires all the properties and behaviors of a parent object. It is an important part of OOPs (Object Oriented programming system).</p><br>
            <p style="font-size: 18px">The idea behind inheritance in Java is that you can create new classes that are built upon existing classes. When you inherit from an existing class, you can reuse methods and fields of the parent class. Moreover, you can add new methods and fields in your current class also.</p><br>
            <p style="font-size: 18px">Inheritance represents the IS-A relationship which is also known as a parent-child relationship.</p><br><br>
            <h1 style="font-size: 35px">Term used in Inheritance</h1><br>
            <p style="font-size: 18px"><u>Class:</u> A class is a group of objects which have common properties. It is a template or blueprint from which objects are created.</p><br>
            <p style="font-size: 18px"><u>Sub Class/Child Class:</u> Subclass is a class which inherits the other class. It is also called a derived class, extended class, or child class.</p><br>
            
             <p style="font-size: 18px"><u>Super Class/Parent Class:</u> Superclass is the class from where a subclass inherits the features. It is also called a base class or a parent class.</p><br>
             <p style="font-size: 18px"><u>Reusability:</u>As the name specifies, reusability is a mechanism which facilitates you to reuse the fields and methods of the existing class when you create a new class. You can use the same fields and methods already defined in the previous clas</p><br><br>
           <h1 style="font-size: 25px">SYNTAX :-</h1><br>
           <p style="font-size: 18px">class Subclass-name extends Superclass-name</p><br>
           <p style="font-size: 18px">{</p><br>
           <p style="font-size: 18px">//methods and fields</p><br>
           <p style="font-size: 18px">}</p><br>
           <p style="font-size: 18px">The extends keyword indicates that you are making a new class that derives from an existing class. The meaning of "extends" is to increase the functionality.</p>           <p style="font-size: 18px"></p><br>
            <img length="200" width="100" src="https://static.javatpoint.com/images/core/inheritance.jpg"> <br><br>
            
            <h1 style="font-size: 25px">Types of Inheritance in java</h1><br>
            <p style="font-size: 18px">There are three types of inheritance in java Single,multilevel and hierarchical</p>
          <img length="200" width="350" src="https://static.javatpoint.com/images/core/typesofinheritance.jpg">
          <h1 style="font-size: 25px">Single Inheritance</h1><br>
           <p style="font-size: 18px">When a class inherits another class, it is known as a single inheritance.</p><br>
           <p style="font-size: 18px">Single inheritance can be defined as a derived class to inherit the basic methods (data members and variables) and behavior from a superclass.</p><br>
            <h1 style="font-size: 25px">Multilevel Inheritance</h1><br>
            <p style="font-size : 18px">When there is a chain of inheritance, it is known as multilevel inheritance.</p><br>
            <p style="font-size: 18px">When a class extends a class, which extends anther class then this is called multilevel inheritance. For example class C extends class B and class B extends class A then this type of inheritance is known as multilevel inheritance.</p><br>
          <img length="200" width="350" src="https://beginnersbook.com/wp-content/uploads/2013/12/Multilevel_Inheritance.jpg">
          <h1 style="font-size: 18px">Hierarchical Inheritance</h1>
          
           <p style="font-size: 18px">When two or more classes inherits a single class, it is known as hierarchical inheritance. </p>
           <p style="font-size: 18px">In such kind of inheritance one class is inherited by many sub classes. In below example class B,C and D inherits the same class A. A is parent class (or base class) of B,C & D. Read More at </p>
            <img length="200" width="350" src="https://beginnersbook.com/wp-content/uploads/2013/05/Hierarchical-Inheritance.png">
            
         <br>
         <br>
         <br>
                     <!-- This should not be in the front page but for example i am writing this here for reference  -->
           <a href="package.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="overloadAndOverride.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
