...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="list.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Java - The List Interface</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->

            <iframe width="560" height="315" src="https://www.youtube.com/embed/EKSfTGHZ_ZE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <p>The List interface extends <b>Collection</b> and declares the behavior of a collection that stores a sequence of elements.</p><br><br>
			<ol>
			<li><p>Elements can be inserted or accessed by their position in the list, using a zero-based index.</p></li>
			<li><p>A list may contain duplicate elements.</p></li>
			<li><p>In addition to the methods defined by <b>Collection</b>, List defines some of its own, which are summarized in the following table.</p></li>
			<li><p>Several of the list methods will throw an UnsupportedOperationException if the collection cannot be modified, and a ClassCastException is generated when one object is incompatible with another.</p></li>
			</ol>
			<br><br>
			...
			<tr>
			<td >1</td>
			<td><p><b>void add(int index, Object obj)</b></p>
			<p>Inserts obj into the invoking list at the index passed in the index. Any pre-existing elements at or beyond the point of insertion are shifted up. Thus, no elements are overwritten.</p>
			</td>
			</tr>
			<tr>
			<td >2</td>
			<td><p><b>boolean addAll(int index, Collection c)</b></p>
			<p>Inserts all elements of <b>c</b> into the invoking list at the index passed in the index. Any pre-existing elements at or beyond the point of insertion are shifted up. Thus, no elements are overwritten. Returns true if the invoking list changes and returns false otherwise.</p>
			</td>
			</tr>
			<tr>
			<td >3</td>
			<td><p><b>Object get(int index)</b></p>
			<p>Returns the object stored at the specified index within the invoking collection.</p>
			</td>
			</tr>
			<tr>
			<td >4</td>
			<td><p><b>int indexOf(Object obj)</b></p>
			<p>Returns the index of the first instance of obj in the invoking list. If obj is not an element of the list, .1 is returned.</p>
			</td>
			</tr>
			<tr>
			<td >5</td>
			<td><p><b>int lastIndexOf(Object obj)</b></p>
			<p>Returns the index of the last instance of obj in the invoking list. If obj is not an element of the list, .1 is returned.</p>
			</td>
			</tr>
			<tr>
			<td >6</td>
			<td><p><b>ListIterator listIterator( )</b></p>
			<p>Returns an iterator to the start of the invoking list.</p>
			</td>
			</tr>
			<tr>
			<td >7</td>
			<td><p><b>ListIterator listIterator(int index)</b></p>
			<p>Returns an iterator to the invoking list that begins at the specified index.</p>
			</td>
			</tr>
			<tr>
			<td >8</td>
			<td><p><b>Object remove(int index)</b></p>
			<p>Removes the element at position index from the invoking list and returns the deleted element. The resulting list is compacted. That is, the indexes of subsequent elements are decremented by one.</p>
			</td>
			</tr>
			<tr>
			<td >9</td>
			<td><p><b>Object set(int index, Object obj)</b></p>
			<p>Assigns obj to the location specified by index within the invoking list.</p>
			</td>
			</tr>
			<tr>
			<td >10</td>
			<td><p><b>List subList(int start, int end)</b></p>
			<p>Returns a list that includes elements from start to end.1 in the invoking list. Elements in the returned list are also referenced by the invoking object.</p>
			</td>
			</tr>
			</table>
			<br><br>
			<h2><b>Example</b></h2>
			<p>The above interface has been implemented in various classes like ArrayList or LinkedList, etc. Following is the example to explain few methods from various class implementation of the above collection methods &minus;</p>
			<div class="demo-view">
			<a href="http://tpcg.io/xOG8bL" target="_blank" class="demo" rel="nofollow"><i class="fa-external-link"></i> Live Demo</a>
			</div>
            ...
            <a href="set.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
            <a href="queue.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
