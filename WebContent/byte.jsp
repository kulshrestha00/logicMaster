...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="byte.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/j6W7cnV7Vc0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >Byte stream in java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
...
<br>
The InputStream and OutputStream classes (abstract) are the super classes of all the input/output stream classes: classes that are used to read/write a stream of bytes. Following are the byte array stream classes provided by Java −</p>
            <br>
            <br>
            <img src="https://lh3.googleusercontent.com/proxy/9eovyWZgPREHzrNDDwrq4X4qMTQLIKHstsCJy4FLKruwk5g-nxk5VgQNO63yP13zM0D-5pSPZVqqYORoXkm1Ur-1GfdkurFGlBypjuMeBt6MrOMVxMhJ7svmAt8" >
            <br>
            <br>
  ...
  <thead>
    <tr class="bg-gray-400">
      ...
      <th class="px-4 py-4">InputStream</th>
      <th class="px-4 py-4">OutputStream</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td class="border px-4 py-4">FIleInputStream  </td>
      <td class="border px-4 py-4">FileOutputStream</td>
      
    </tr>
    <tr >
      <td class="border px-4 py-4">ByteArrayInputStream</td>
      <td class="border px-4 py-4">ByteArrayOutputStream</td>
     
    </tr>
    <tr>
      <td class="border px-4 py-4">PipedInputStream</td>
      <td class="border px-4 py-4">PipedOutputStream</td>
      
    </tr>
    <tr>
      <td class="border px-4 py-4">FilteredInputStream</td>
      <td class="border px-4 py-4">FilteredOutputStream</td>
      
    </tr>
    <tr>
      <td class="border px-4 py-4">BufferedInputStream</td>
      <td class="border px-4 py-4">BufferedOutputStream</td>
      
    </tr>
    <tr>
      <td class="border px-4 py-4">DataInputStream </td>
      <td class="border px-4 py-4">DataOutputStream</td>
         ...
         <hr>
           ...
           <a href="io.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="character.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
