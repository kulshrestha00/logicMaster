...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="throwAndThrows.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
               Throw and throws
            </a>
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Difference between throw and throws in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <!-- Video Tag -->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/0N-DhLQ5pxs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <br>
           
            <p>Both throw and throws are the concepts of exception handing in which throw is used to explicitly throw an exception from a method or any block of code while throws are used in the signature of the method to indicate that this method might throw one of the listed type exceptions.</p><p>The following are the important differences between throw and throws.</p><table class="table table-bordered"><thead><tr><th style="width: 8.9796%;">Sr. No.</th><th style="text-align: center; width: 11.7007%;">Key</th><th style="text-align:center;">throw</th><th style="text-align:center;">throws</th></tr></thead><tbody><tr><td style="text-align: center; vertical-align: middle; width: 8.9796%;">1</td><td style="width: 11.7007%;">Definition</td><td>Throw is a keyword which is used to throw an exception explicitly in the program inside a function or inside a block of code.</td><td>Throws is a keyword used in the method signature used to declare an exception which might get thrown by the function while executing the code.</td></tr><tr><td style="text-align: center; vertical-align: middle; width: 8.9796%;">2</td><td style="width: 11.7007%;">Internal implementation</td><td>Internally throw is implemented as it is allowed to throw only single exception at a time i.e we cannot throw multiple exception with throw keyword.</td><td>On other hand we can declare multiple exceptions with throws keyword that could get thrown by the function where throws keyword is used.</td></tr><tr><td style="text-align: center; vertical-align: middle; width: 8.9796%;">3</td><td style="width: 11.7007%;">Type of exception</td><td>With throw keyword we can propagate only unchecked exception i.e checked exception cannot be propagated using throw.</td><td>On other hand with throws keyword both checked and unchecked exceptions can be declared and for the propagation checked exception must use throws keyword followed by specific exception class name.</td></tr><tr><td style="text-align: center; vertical-align: middle; width: 8.9796%;">4</td><td style="width: 11.7007%;">Syntax</td><td>Syntax wise throw keyword is followed by the instance variable.</td><td>On other hand syntax wise throws keyword is followed by exception class names.</td></tr><tr><td style="text-align: center; vertical-align: middle; width: 8.9796%;">5</td><td style="width: 11.7007%;">Declaration</td><td>In order to use throw keyword we should know that throw keyword is used within the method.</td><td>On other hand throws keyword is used with the method signature.</td></tr></tbody></table><h2>Example of throw vs throws</h2><p><strong>JavaTester.java</strong></p><p><a class="demo" href="http://tpcg.io/tEUxIO" rel="nofollow" target="_blank">&nbsp;Live Demo</a></p><pre class="prettyprint notranslate">public class JavaTester{
			...
			&nbsp; &nbsp;}
			}</pre><br><br><h2><b>Output</b></h2><br><br><pre class="result notranslate">Exception in thread &quot;main&quot; java.lang.ArithmeticException:
			Not Eligible for voting
			at JavaTester.checkAge(JavaTester.java:4)
			at JavaTester.main(JavaTester.java:10)</pre><h2>Example</h2><p><strong>JavaTester.java</strong></p><p><a class="demo" href="http://tpcg.io/2tt5Od" rel="nofollow" target="_blank">&nbsp;Live Demo</a></p><pre class="prettyprint notranslate">public class JavaTester{
			...
			&nbsp; &nbsp; &nbsp; }
			&nbsp; &nbsp;}
			}</pre><br><br><h2><b>Output</b></h2><br><br><pre class="result notranslate">You shouldn&#39;t divide number by zero</pre>
            <br>
            ...
            <a href="exceptionHandeling.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
            <a href="threads.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
