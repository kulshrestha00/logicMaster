...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="this.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b" >This keyword in Java</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
             <br>
            <br>
	<!--Video Tag-->
            <iframe width="560" height="315" src="https://www.youtube.com/embed/HD5IyaOgdPQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<br>
            <p style="font-size: 18px">The this keyword refers to the current object in a method or constructor.</p><br>
           <p style="font-size: 18px">The most common use of the this keyword is to eliminate the confusion between class attributes and parameters with the same name (because a class attribute is shadowed by a method or constructor parameter). If you omit the keyword in the example above, the output would be "0" instead of "5".</p><br>
           
                      <br>
            <h1 style="font-size: 35px">Usage of this keyword</h1>
            <p style="font-size: 18px">1.) this can be used to refer current class instance variable.</p><br>
            <p style="font-size: 18px">2.) this can be used to invoke current class method (implicitly)
            </p><br>
            <p style="font-size: 18px">3.) this() can be used to invoke current class constructor.</p><br>
            <p style="font-size: 18px">4.) this can be passed as argument in the constructor call.</p>
            <br>
            <br>
            <h1 style="font-size: 35px">Example :-</h1><br>
            <p style="font-size: 18px">public class MyClass {</p><br>
            <p style="font-size: 18px">int x;</p><br>
            <p style="font-size: 18px">// Constructor with a parameter</p><br>
            <p style="font-size: 18px"> public MyClass(int x) {</p><br>
            <p style="font-size: 18px">this.x = x;</p><br>
            <p style="font-size: 18px"> }</p><br><br>
            <p style="font-size: 18px"> // Call the constructor</p><br>
             <p style="font-size: 18px"> public static void main(String[] args) {</p><br>
              <p style="font-size: 18px"> MyClass myObj = new MyClass(5);</p><br>
               <p style="font-size: 18px"> System.out.println("Value of x = " + myObj.x);</p><br>
         ...
         <br>
           ...
           <a href="static.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="arrays.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
