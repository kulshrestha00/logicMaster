...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;"> 
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="jdk.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
              JDK, JVM and JRE
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">JDK, JRE, JVM</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->

                        <hr style="color: black">
            <br>
            <br>
            <div class="video-responsive">
<iframe width="560" height="315" src="https://www.youtube.com/embed/wKrpMmrfH34" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

</div>

            <br>
            <h1 style="font-size: 35px"><b>What is JVM ?</b></h1>
            <p style="font-size: 18px">JVM(Java Virtual Machine) acts as a run-time engine to run Java applications. JVM is the one that actually calls the main method present in a java code. JVM is a part of JRE(Java Runtime Environment).
...
When we compile a .java file, .class files(contains byte-code) with the same class names present in .java file are generated by the Java compiler. This .class file goes into various steps when we run it. These steps together describe the whole JVM.</p>
            ...
            <h1 style="font-size: 35px"><b>What is JRE?</b></h1>
             <p style="font-size: 18px">JRE is the implementation of JVM and contains libraries and other files which are used by JVM. JRE is used by a Java-based application to execute java programs.</p>
            <div align=left>
           <br><br>
           <h1 style="font-size: 35px"><b>What is JDK?</b></h1>
            <p style="font-size: 18px">JDK is set of JRE and development tools like javac and java etc. JDK is used to develop Java programs and Java-based applications.
            ...
            <h1 style="font-size: 35px; ">JDK is an implementation of any one of the below given Java Platforms released by Oracle Corporation: </h1> 
           <pre style="font-size: 18px">  .
           <br></pre>
      
      <ul style="list-style-type:square; padding-left:5em">
                <li>
                    <b style="font-size: 18px">Standard Edition Java Platform </b>
                </li>
                <li>
                    <b style="font-size: 18px">Enterprise Edition Java Platform</b> 
                </li>
                <li>
                    <b style="font-size: 18px">Micro Edition Java Platform</b>
                </li>
                </ul>
                 <div>
...
<hr style="color: black">
         ...
         <br>
           ...
           <a href="oop.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
           <a href="jvmArch.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
