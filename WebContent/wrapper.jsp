...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="wrapper.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Wrapper Class</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->
            <hr style="color: black">
            <br>
            <br>
            <!-- Video Tag -->
           <iframe width="560" height="315" src="https://www.youtube.com/embed/XKEBjp1k8cQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <br>
            <p>A <strong>Wrapper class</strong> is a class which contains the<strong>&nbsp;primitive data types</strong> (<strong>int, char, short, byte, etc)</strong>. In other words, wrapper classes provide a way to use <strong>primitive data types</strong>
			<strong>(int, char, short, byte, etc) as objects</strong>. These wrapper classes come under<strong>&nbsp;java.util package</strong>.</p>
            <br>
			...
			<h2>Why we need Wrapper Class</h2><ul class="list"><li>Wrapper Class will <strong>convert primitive data types into objects</strong>. The objects are necessary if we wish to modify the arguments passed into the method (because primitive types are <strong>passed by value</strong>).</li><li>The classes in <strong>java.util package</strong> handles only objects and hence <strong>wrapper classes&nbsp;</strong>help in this case also.</li><li><strong>Data</strong>
			<strong>structures</strong> in the Collection framework such as <strong>ArrayList and Vector&nbsp;</strong>store only the objects (reference types) and not the<strong>&nbsp;primitive types.</strong></li><li>The object is needed to support <strong>synchronization</strong> in <strong>multithreading</strong>.</li></ul><h2><br></h2><h2>Implementation of the wrapper class in Java</h2><h2>Autoboxing in Wrapper Class</h2><p>Autoboxing is used to <strong>convert primitive data types into corresponding objects</strong>.</p><h2>Example</h2><p><a class="demo" href="http://tpcg.io/xL9XA2
			" rel="nofollow" target="_blank">Live Demo</a></p><pre class="prettyprint notranslate">public class AutoBoxingTest {
			&nbsp; &nbsp;public static void main(String args[]) {
			&nbsp; &nbsp; &nbsp; int num = 10; // int primitive
			&nbsp; &nbsp; &nbsp; Integer obj = Integer.valueOf(num); // <strong>creating a wrapper class object</strong>
			&nbsp; &nbsp; &nbsp; System.out.println(num + &quot; &quot; + obj);
			&nbsp; &nbsp;}
			}</pre><h2>Output</h2><pre class="result notranslate">10 10</pre><h2>Unboxing in Wrapper Class</h2><p>Unboxing is used to <strong>convert the Wrapper class object into corresponding primitive data types</strong>.</p><h2>Example</h2><p><a class="demo" href="http://tpcg.io/akzgCN
			" rel="nofollow" target="_blank">Live Demo</a></p><pre class="prettyprint notranslate">public class UnboxingTest {
			&nbsp; &nbsp;public static void main(String args[]) {
			&nbsp; &nbsp; &nbsp; Integer obj = new Integer(10); // <strong>Creating Wrapper class object</strong>
			&nbsp; &nbsp; &nbsp; int num = obj.intValue(); // <strong>Converting the wrapper object to primitive datatype</strong>
			&nbsp; &nbsp; &nbsp; System.out.println(num + &quot; &quot; + obj);
			&nbsp; &nbsp;}
			}</pre><h2>Output</h2><pre class="result notranslate">10 10</pre><div class="clear"></div>
            <br>
            ...
            <a href="calender.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
            <a href="collection.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
